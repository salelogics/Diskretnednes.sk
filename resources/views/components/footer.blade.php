...
<footer class="bg-black dark:bg-gray-950">
  <div class="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
    ...
    <div class="mt-16 flex justify-center gap-x-10">
      ...
      <a href="https://www.instagram.com/erotikon.sk/" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-gray-300 dark:text-gray-300 dark:hover:text-gray-100">
