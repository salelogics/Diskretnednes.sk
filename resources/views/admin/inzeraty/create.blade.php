            ...
            <div class="bg-white shadow-xl rounded-2xl border border-gray-100">
                ...
                <div class="px-6 py-6 space-y-8">
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="10" required minlength="20" class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-pink-500 focus:border-pink-500" placeholder="Opíšte svoje služby, čo ponúkate, vaše skúsenosti...">{{ old('description') }}</textarea>
