...
class PaymentCompletedMail extends Mailable
{
    ...
    public function __construct(AdPayment $payment)
    {
        ...
        // Načítame EmailTemplate z databázy - používame payment_instructions ako base
    ...
    private function getTemplateData(): array
    {
        return [
            ...
            'due_date' => $this->payment->created_at ? $this->payment->created_at->format('d.m.Y') : 'Neznámy',
        ];
    }
